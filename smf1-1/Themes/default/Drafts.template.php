...
function template_show_drafts()
{
	...
	echo '
		<form action="', $scripturl, '?action=profile;sa=show_drafts;u=', $context['user']['id'], '" method="post" accept-charset="', $context['character_set'], '">
		<table border="0" width="85%" cellspacing="1" cellpadding="5" class="bordercolor" align="center">
			<tr class="titlebg">
				<td colspan="7" height="26">
					&nbsp;<img src="', $settings['images_url'], '/icons/profile_sm.gif" alt="" align="top" />&nbsp;', $txt['drafts'][2], '
				</td>
			</tr>';
		...
		echo '
			<tr class="windowbg', $i % 2 ? '2' : '', '">
				<td colspan="7" align="right">
					<input type="submit" value="', $txt['drafts'][11], '" onclick="return confirm(\'', $txt['drafts'][12], '\');" />
				</td>
			</tr>';
	}
	else
...
function template_drafts_post_save_as_draft_button()
{
	...
	echo '
									<input type="submit" onclick="document.getElementById(\'drafts-save_as_draft\').value = \'1\';" value="', $txt['drafts'][14], '" />';
}
